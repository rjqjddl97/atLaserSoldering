...
namespace LFineLightLibrary.SerialCommunication.Control
{
    public class CommunicationManager
    {
        ...
        public delegate void DataPasorEventHandler(LFineData data);
        ...
        public event Action<LFineData> ReceiveDataUpdateEvent;
        ...
        public CommunicationManager()
        {
            ...
            mLightData = mSerialEngine.m_LightData;
            //ConnectEvents();
        }
        ...
        private void ConnectEvents()
        {
            ...
            mSerialEngine.ReceiveLightData += ReceiveUpdateData;
        ...
        public void ReceiveUpdateData(LFineData data)
        {
            //PresentVoltage = data.PresentValue;
            mLightData = data;
            ReceiveDataUpdateEvent.Invoke(mLightData);
        }
