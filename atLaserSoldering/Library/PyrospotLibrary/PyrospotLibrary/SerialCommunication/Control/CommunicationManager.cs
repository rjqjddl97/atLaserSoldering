...
namespace PyrospotControlLibrary.SerialCommunication.Control
{
    public class CommunicationManager
    {
        ...
        public delegate void DataPasorEventHandler(PyrospotData data);
        ...
        public event Action<int> ReceiveDataUpdateEvent;

        readonly SerialProcessEngine mSerialEngine;
        readonly SerialHandler mSerialHandler;

        public PyrospotData mPyrospotData;
        ...
        public CommunicationManager()
        {
            ...
            mPyrospotData = new PyrospotData();
            //ConnectEvents();
        }
        ...
        private void ConnectEvents()
        {
            ...
            mSerialEngine.ReceivePyrospotData += PrevalueUpdateData;            
        ...
        public void PrevalueUpdateData(int data)
        {
